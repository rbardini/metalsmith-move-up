...
var async = require('async') // for filtering and enumerating files
...
function normalizeInput (transforms) {
  ...
  function addTransforms (transforms) {
...
module.exports = function moveUp (transforms) {
  ...
  return function (files, metalsmith, callback) {
    ...
    function onNextTransform (transform, next) {
      ...
      async.filter(Object.keys(files), shouldProcess, function (_err, results) {
